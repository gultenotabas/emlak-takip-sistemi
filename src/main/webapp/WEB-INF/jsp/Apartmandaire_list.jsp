...
<head>
    ...
    <title>Apartmandaire Listesi</title>
            ...
            <div class="well">
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${apartmandaireList}" var="apartmandaire" >
                        <tr>
                            <td>${Apartmandaire.id}</td>

                            <td>
                                <spring:url value="/apartmandaire/editApartmandaire/${apartmandaire.id}" var="editURL" />
                                <a class="btn btn-info" href="${editURL}" role="button" >Güncelle</a>
                            </td>

                            <td>
                                <spring:url value="/apartmandaire/deleteApartmandaire/${apartmandaire.id}" var="deleteURL" />
