                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${dukkanList}" var="dukkan" >
                        <tr>
                            ...
                            <td>
                                <spring:url value="/dukkan/editDukkan/${dukkan.id}" var="editURL" />
                                <a class="btn btn-info" href="${editURL}" role="button" >Güncelle</a>
                            </td>

                            <td>
                                <spring:url value="/dukkan/deleteDukkan/${dukkan.id}" var="deleteURL" />
